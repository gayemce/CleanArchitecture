...
public sealed class AuthService : IAuthService
{
    ...
    public AuthService(UserManager<User> userManger, IMapper mapper, IMailService mailService, IJwtProvider jwtProvider)
    {
    ...
    {
        User user = await _userManger.FindByIdAsync(request.UserId);
